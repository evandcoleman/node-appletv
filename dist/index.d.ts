...
*/
export declare function scan(uniqueIdentifier?: string, timeout?: number): Promise<TVClient[]>;
/**
...
export { AppleTV, TVClient, Browser, NowPlayingInfo, Credentials, Message, SupportedCommand };
