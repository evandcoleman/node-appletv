...
*/
export declare function scan(uniqueIdentifier?: string, timeout?: number, log?: (string) => void): Promise<Array<AppleTV>>;
/**
...
export { AppleTV, Browser, NowPlayingInfo, Credentials };
